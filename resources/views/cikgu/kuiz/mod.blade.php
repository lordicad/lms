    ...
    <div class="tp-formwrap">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:18px">
            <a href="{{ route('cikgu.kuiz.create', ['jenis' => 'interactive']) }}" class="tp-typecard">
                ...
                <h2 class="tp-g" style="font-size:19px;font-weight:800;color:#28293F">{{ __('Bina Kuiz Interaktif') }}</h2>
                <p style="margin:0;font-size:14.5px;color:#6C6F87;line-height:1.55">{{ __('Bina soalan aneka pilihan terus dalam sistem. Murid menjawab dalam talian dan mendapat markah serta-merta. Kuiz jenis ini memberi mata ranking.') }}</p>
            ...
            <a href="{{ route('cikgu.kuiz.create', ['jenis' => 'file']) }}" class="tp-typecard">
                ...
                <h2 class="tp-g" style="font-size:19px;font-weight:800;color:#28293F">{{ __('Muat Naik Fail Kuiz') }}</h2>
                <p style="margin:0;font-size:14.5px;color:#6C6F87;line-height:1.55">{{ __('Muat naik kuiz sedia ada sebagai fail PDF atau Word untuk dicetak. Murid hanya boleh melihat dan memuat turun. Tiada penandaan automatik dan tiada mata ranking.') }}</p>
                <span class="tp-g" style="margin-top:auto;font-weight:800;font-size:14px;color:#17907B">{{ __('Pilih ini') }}</span>
            </a>
        </div>
    </div>
