<x-student-layout :title="__('Kuiz')">
    <style>
        ...
        /* Stacked on phones: extra breathing room above the "Kuiz Dicadangkan" heading. */
        @media (max-width: 900px) { .kz-cols { grid-template-columns: 1fr; gap: 52px; } }
    ...
    <div style="display:flex;flex-direction:column;gap:24px">
        <div class="wl-favhead" style="display:flex;align-items:flex-start;gap:16px">
            ...
            <div style="display:flex;flex-direction:column;gap:2px;min-width:0">
                ...
                <span style="font-size:14px;font-weight:600;color:var(--wl-muted)">{{ $grade?->displayName() ?? __('Tahun anda belum ditetapkan') }}</span>
            </div>
        </div>
