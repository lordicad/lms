<x-student-layout :title="__('Subjek')">
    ...
    <style>
        html.theme-dark .sc-0 { background:linear-gradient(135deg,#2E425C,#25344B) !important; box-shadow:0 0 30px rgba(96,140,200,.32), 0 6px 18px rgba(0,0,0,.35) !important; }
        html.theme-dark .sc-1 { background:linear-gradient(135deg,#3E3768,#332C57) !important; box-shadow:0 0 30px rgba(146,126,214,.32), 0 6px 18px rgba(0,0,0,.35) !important; }
        html.theme-dark .sc-2 { background:linear-gradient(135deg,#5A3A4C,#48303E) !important; box-shadow:0 0 30px rgba(206,124,156,.32), 0 6px 18px rgba(0,0,0,.35) !important; }
        html.theme-dark .sc-3 { background:linear-gradient(135deg,#265042,#1F4237) !important; box-shadow:0 0 30px rgba(78,186,150,.32), 0 6px 18px rgba(0,0,0,.35) !important; }
        html.theme-dark .sc-4 { background:linear-gradient(135deg,#5A4E2E,#484023) !important; box-shadow:0 0 30px rgba(206,176,92,.32), 0 6px 18px rgba(0,0,0,.35) !important; }
        html.theme-dark .sc-5 { background:linear-gradient(135deg,#5A4238,#48342C) !important; box-shadow:0 0 30px rgba(214,150,120,.32), 0 6px 18px rgba(0,0,0,.35) !important; }
        /* Stronger on hover (the card also lifts via .wl-lift). */
        html.theme-dark .sc-0:hover { box-shadow:0 0 42px rgba(96,140,200,.46), 0 12px 26px rgba(0,0,0,.4) !important; }
        html.theme-dark .sc-1:hover { box-shadow:0 0 42px rgba(146,126,214,.46), 0 12px 26px rgba(0,0,0,.4) !important; }
        html.theme-dark .sc-2:hover { box-shadow:0 0 42px rgba(206,124,156,.46), 0 12px 26px rgba(0,0,0,.4) !important; }
        html.theme-dark .sc-3:hover { box-shadow:0 0 42px rgba(78,186,150,.46), 0 12px 26px rgba(0,0,0,.4) !important; }
        html.theme-dark .sc-4:hover { box-shadow:0 0 42px rgba(206,176,92,.46), 0 12px 26px rgba(0,0,0,.4) !important; }
        html.theme-dark .sc-5:hover { box-shadow:0 0 42px rgba(214,150,120,.46), 0 12px 26px rgba(0,0,0,.4) !important; }
    </style>
        ...
        <div style="display:flex;flex-direction:column;gap:18px">
            <div style="display:flex;align-items:flex-start;gap:16px">
                ...
                <div style="display:flex;flex-direction:column;gap:2px;min-width:0">
                    ...
                    <span style="font-size:14px;font-weight:600;color:var(--wl-muted)">{{ $grade->displayName() }} · {{ __('Pilih subjek untuk melihat bab dan video') }}</span>
                </div>
            </div>
