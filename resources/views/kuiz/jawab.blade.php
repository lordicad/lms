<x-student-layout :title="$quiz->title">
    <style>
        ...
        .qopt2 { position:relative; display:flex; align-items:center; gap:16px; border-radius:16px; padding:18px 20px; cursor:pointer; transition:transform .1s ease-out, box-shadow .12s; background:var(--tint); }
        ...
        .q2letter { width:40px; height:40px; border-radius:11px; flex-shrink:0; display:grid; place-items:center; font-family:'Geist',sans-serif; font-weight:800; font-size:15px; background:#fff; color:var(--solid); box-shadow:0 1px 3px rgba(46,44,80,.12); }
        .qopt2:has(input:checked) .q2letter { background:rgba(255,255,255,.25); color:#fff; box-shadow:none; }
        .q2text { flex:1; min-width:0; font-family:'Geist',sans-serif; font-weight:800; font-size:16px; color:var(--wl-ink); }
