@php
    ...
    $stats = [
        ['icon' => 'video',   'label' => __('Jumlah video'),      'value' => $totalCount],
        ['icon' => 'youtube', 'label' => __('Video YouTube'),     'value' => $youtubeCount],
        ['icon' => 'upload',  'label' => __('Video dimuat naik'), 'value' => $uploadCount],
    ];
@endphp
