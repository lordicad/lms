...
<head>
    ...
    <style>
        ...
        @media (max-width:900px) {
            ...
            .tp-heading .hi-tile { width:34px !important; height:34px !important; border-radius:10px !important; }
            .tp-heading .hi-tile img { width:20px !important; height:20px !important; }
            .tp-heading .hi-tile svg { width:19px !important; height:19px !important; }
            .tp-heading .hi-tile > span { font-size:19px !important; }
            .tp-heading .tp-h1 { font-size:19px !important; }
            .tp-heading .tp-hsub { font-size:12.5px !important; }
            ...
            .ysf-form-cikgu { flex-wrap:wrap !important; column-gap:8px !important; row-gap:7px !important; align-items:flex-end; margin-bottom:-10px; }
            ...
            .ysf-form-cikgu .ss-trigger { min-height:34px !important; font-size:11.5px !important; padding:0 26px 0 10px !important; }
            .ysf-form-cikgu .ss-chevron { width:13px !important; height:13px !important; }
            .ysf-form-cikgu select.tp-filter-select { min-width:0 !important; width:100% !important; min-height:34px !important; font-size:11.5px !important; }
            .ysf-form-cikgu > .ysf-reset { flex:0 0 auto !important; margin-right:auto !important; margin-left:12px !important; min-height:38px !important; font-size:12.5px !important; }
            ...
            .tp-listcard:has(.tp-vidthumb) .tp-listactions { grid-area:actions; border-top:1px solid var(--tp-line); padding-top:10px; justify-content:flex-start; flex:unset !important; }
            ...
            /* Ranking table: slightly smaller text throughout. */
            .tp-ranktable [style*="font-size:15px"] { font-size:13px !important; }
            ...
            .tp-chapicker .tp-label { font-size:12px !important; }
            ...
            .tp-input:not([type=checkbox]):not([type=radio]):not([type=range]):not([type=file]),
            .tp-textarea { font-size:14px !important; }
