...
<head>
    ...
    <style>
        ...
        .tp-typeopt { border:1.5px solid var(--tp-line-2); background:#fff; border-radius:14px; padding:16px 18px; display:flex; gap:12px; align-items:flex-start; cursor:pointer; text-decoration:none; }
