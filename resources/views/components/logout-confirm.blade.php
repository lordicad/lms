...
<div x-data="{ open: false }" style="display:contents">
    ...
    <template x-teleport="body">
        ...
        <div x-show="open" x-cloak x-transition.opacity
            ...
            <div @click.stop x-show="open" x-transition.opacity
                 style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);width:min(380px,calc(100vw - 48px));box-sizing:border-box;background:#fff;border-radius:22px;box-shadow:0 24px 70px rgba(20,20,40,.35);padding:30px 28px;display:flex;flex-direction:column;align-items:center;text-align:center">
