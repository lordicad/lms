<x-student-layout :title="app()->getLocale() === 'en' ? 'Leaderboard' : 'Kedudukan'">
    <style>
        ...
        @media (max-width: 640px) {
            ...
            /* Ranks 4-10 table: smaller text + avatar; widen the rank column so "Kedudukan" fits
               inside it and clears "Peserta". */
            .lb-tbl-head, .lb-tr { grid-template-columns: 56px minmax(0,1fr) auto !important; gap: 12px; padding: 10px 12px; }
